...
?>
<form enctype="multipart/form-data" method="post" action="doneeregcheck.php">
<div class="text-box">
...
<p style="color:#4caf50;">If you already have an account?<a href="doneelog.php">Sign In</a></p>
</form>
</div>
</body>
</html>